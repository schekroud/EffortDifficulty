...
# -*- coding: utf-8 -*-
"""
Created on Sat Feb 10 18:37:04 2024
...
for i in subs:
    ...
    ibetas  = np.load(file = op.join(glmdir, param['subid'] + '_stim1lockedEyes_betas.npy'))
    icopes  = np.load(file = op.join(glmdir, param['subid'] + '_stim1lockedEyes_copes.npy'))
    itstats = np.load(file = op.join(glmdir, param['subid'] + '_stim1lockedEyes_tstats.npy'))
