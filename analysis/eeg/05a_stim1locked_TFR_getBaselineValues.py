...
for i in subs:
    ...
    tfr = mne.time_frequency.read_tfrs(param['stim1locked'].replace('-epo.fif', '-tfr.h5').replace('-tfr.h5', '_Alpha-tfr.h5')); tfr = tfr[0]#.replace('stim1locked', 'stim1locked_cleaned').replace('-epo.fif', '-tfr.h5')); tfr = tfr[0]
