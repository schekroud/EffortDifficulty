...
figpath = op.join(wd, 'figures', 'decoding')
...
fig.savefig(op.join(figpath, f'decoding_RidgeClassifier_allTrials_vischansonly{use_vischans_only}_usePca{use_pca}_{testtype}.pdf'), format = 'pdf', dpi = 400)
