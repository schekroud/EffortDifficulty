...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun 18 15:29:26 2024
...
for i in subs:
    ...
    epochs    = mne.read_epochs(param['stim2locked'].replace('stim2locked', 'stim2locked_icaepoched_resamp'), preload=True)
    ...
    epochs.save(fname = param['stim2locked'].replace('stim2locked', 'stim2locked_icaepoched_resamp_cleaned'), overwrite=True)
