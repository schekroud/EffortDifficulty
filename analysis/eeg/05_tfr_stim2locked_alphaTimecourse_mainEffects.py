...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 16 12:55:31 2023
...
# ax.axvline(x = 0, ymin = gmean.mean(0).min(), ymax=gmean.mean(0).max(), ls = 'dashed', lw = 1, color = '#000000')
fig.legend()
...
ax.fill_between(times,
                ...
                y2 = np.add(d12.mean(axis=0), sp.stats.sem(d12, axis =0, ddof = 0)), color = '#1a9641', alpha = 0.2)
fig.legend()