...
ax.set_ylabel('Alpha power (Beta, AU)')
fig.tight_layout()
# fig.savefig(op.join(figpath, 'model2_allTrials_prevtrlfb_prevtrlCorrectIncorrect%s_twin_preStim.pdf'%addtopath), format = 'pdf', dpi = 400)
...
ax.set_ylabel('Alpha power (Beta, AU)')
fig.tight_layout()
# fig.savefig(op.join(figpath, 'model2_allTrials_prevtrlfb_prevtrlCorrectIncorrect%s_twin_postStim.pdf'%addtopath), format = 'pdf', dpi = 400)